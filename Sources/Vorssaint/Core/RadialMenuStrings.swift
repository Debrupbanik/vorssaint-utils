...
struct RadialMenuFeatureStrings {
    ...
    let mouseDragToActivateLabel: String
    let mouseDragToActivateCaption: String
...
extension RadialMenuFeatureStrings {
    static let enUS = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Drag to activate",
        mouseDragToActivateCaption: "Hold and drag to open the radial menu; a normal click keeps its default action in apps.",
    ...
    static let ptBR = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Arrastar para ativar",
        mouseDragToActivateCaption: "Mantenha pressionado e arraste para abrir o menu radial; um clique normal mantém sua ação padrão nos apps.",
    ...
    static let tr = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Etkinleştirmek için sürükleyin",
        mouseDragToActivateCaption: "Radyal menüyü açmak için basılı tutup sürükleyin; normal bir tıklama uygulamalardaki varsayılan eylemini korur.",
    ...
    static let ru = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Перетащите для активации",
        mouseDragToActivateCaption: "Удерживайте и перетащите, чтобы открыть радиальное меню; обычный клик сохраняет стандартное действие в приложениях.",
    ...
    static let es = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Arrastrar para activar",
        mouseDragToActivateCaption: "Mantén pulsado y arrastra para abrir el menú radial; un clic normal conserva su acción predeterminada en las apps.",
    ...
    static let de = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Zum Aktivieren ziehen",
        mouseDragToActivateCaption: "Gedrückt halten und ziehen, um das Radialmenü zu öffnen; ein normaler Klick behält seine Standardaktion in Apps bei.",
    ...
    static let fr = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Faire glisser pour activer",
        mouseDragToActivateCaption: "Maintenez et faites glisser pour ouvrir le menu radial ; un clic normal conserve son action par défaut dans les applications.",
    ...
    static let it = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "Trascina per attivare",
        mouseDragToActivateCaption: "Tieni premuto e trascina per aprire il menu radiale; un normale clic mantiene la sua azione predefinita nelle app.",
    ...
    static let ja = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "ドラッグして起動",
        mouseDragToActivateCaption: "長押ししてドラッグするとラジアルメニューが開きます。通常のクリックではアプリのデフォルト操作が維持されます。",
    ...
    static let ko = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "드래그하여 활성화",
        mouseDragToActivateCaption: "길게 누른 채 드래그하여 원형 메뉴를 엽니다. 일반 클릭 시 앱의 기본 동작이 유지됩니다.",
    ...
    static let zhHans = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "拖拽以打开",
        mouseDragToActivateCaption: "按住并拖拽即可打开径向菜单；单击则保留其在 App 中的默认操作。",
    ...
    static let zhTW = RadialMenuFeatureStrings(
        ...
        mouseDragToActivateLabel: "拖曳以開啟",
        mouseDragToActivateCaption: "按住並拖曳即可開啟環形選單；按一下則保留其在應用程式中的預設操作。",
